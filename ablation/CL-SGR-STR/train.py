...
def train_cl(args, best_ade, model, train_datasets, val_datasets, replay_model="none", iters=2, batch_size=32,
    ...
    for task, train_dataset in enumerate(train_datasets, 1):
        ...
        if args.val:
            if Generative:
                replay_data_loader_val = iter(data_loader(args, val_datasets[task-2], args.replay_batch_size))
        ...
        for epoch in range(1, iters_to_use+1):
            ...
            for batch_index, batch in enumerate(training_dataset):
                ...
                if batch_index <= iters*batch_num:
                    ...
                    main_loss_file = open("{}/loss_main_model_{}_{}_{}_{}.txt".format(args.r_dir, args.dataset_order, args.replay, args.val_class, args.si), 'a')
